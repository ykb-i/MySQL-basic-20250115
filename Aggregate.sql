...
-- 결과 및 사용법이 WHERE절과 비슷하게 보이지만, WHERE 절은 조회할 때 사용, HAVING 절은 조회 후에 사용됨
SELECT 
    MIN(amount) '최소', 
    MAX(amount) '최대', 
    employee_number '사번'
